...
{
    [Serializable]
    public class AddCompensationComponentConfirmationStep :
        StepBase<AddCompensationComponentConfirmationStep>,IConfirmationAction
    {
        ...
        private void Insert(TenantOnboardingOrchestrator parent,
            [Inject] IAddCompensationComponentConfirmationStepDal dal)
        {
            using (BypassPropertyChecks)
            {
                var dto = new AddCompensationComponentConfirmationStepDto
                {
