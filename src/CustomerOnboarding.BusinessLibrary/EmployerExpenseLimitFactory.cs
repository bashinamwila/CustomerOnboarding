...
{
    [Serializable]
    public class EmployerExpenseLimitFactory : ReadOnlyBase<EmployerExpenseLimitFactory>
    {
        ...
        [Fetch]
        private void Fetch(int id, string ruleSet, [Inject] IDataPortal<EmployerExpenseLimitTypeTypeInfo> dp,
        ...
        private void Fetch(int type, string tenantId, string id,
            string ruleSet,
            [Inject] IDataPortal<EmployerExpenseLimitTypeTypeInfo> dp,
            [Inject] ApplicationContext appCtx)
        {
