...
{
    [Serializable]
    public class AddEmployerExpenseConfirmationStep :
        StepBase<AddEmployerExpenseConfirmationStep>, IConfirmationAction
    {
        ...
        private void Insert(TenantOnboardingOrchestrator parent,
            [Inject] IAddEmployerExpenseConfirmationStepDal dal)
        {
            using (BypassPropertyChecks)
            {
                var dto = new AddEmployerExpenseConfirmationStepDto
                {
