...
{
    [Serializable]
    public class GeneralDeductionsInformationStep :
        StepBase<GeneralDeductionsInformationStep>, IInformationOnlyStep
    {
        ...
        private void Insert(TenantOnboardingOrchestrator parent,
           [Inject] IGeneralDeductionsInformationDal dal)
        {
            using (BypassPropertyChecks)
            {
                var dto = new GeneralDeductionsInformationDto
                {
