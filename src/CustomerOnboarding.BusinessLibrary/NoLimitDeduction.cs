...
{
    [Serializable]
    public class NoLimitDeduction : BusinessBase<NoLimitDeduction>, ILimit
    {
        ...
        [InsertChild]
        private void Insert(TenantOnboardingOrchestrator parent, [Inject] INoDeductionLimitDal dal)
        {
            using (BypassPropertyChecks)
            {
        ...
        [UpdateChild]
        private void Update(TenantOnboardingOrchestrator parent, [Inject] INoDeductionLimitDal dal)
        {
            //Do Notihng
        }
        [FetchChild]
        private void Fetch(string tenantId,string id,string ruleSet,[Inject] INoDeductionLimitDal dal)
        {
        ...
        [DeleteSelfChild]
        private void DeleteSelf(string tenantId,string id, [Inject] INoDeductionLimitDal dal)
        {
            dal.Delete(tenantId,id);
        }
        [DeleteSelfChild]
        private void Delete(TenantOnboardingOrchestrator parent, [Inject] INoDeductionLimitDal dal)
        {
