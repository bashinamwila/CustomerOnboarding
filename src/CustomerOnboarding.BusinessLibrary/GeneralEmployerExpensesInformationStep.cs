...
{
    [Serializable]
    public class GeneralEmployerExpensesInformationStep :
        StepBase<GeneralEmployerExpensesInformationStep>, IInformationOnlyStep
    {
        ...
        private void Insert(TenantOnboardingOrchestrator parent,
           [Inject] IGeneralEmployerExpensesInformationDal dal)
        {
            using (BypassPropertyChecks)
            {
                var dto = new GeneralEmployerExpensesInformationDto
                {
