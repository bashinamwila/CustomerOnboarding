...
{
    [Serializable]
    public class AddDeductionConfirmationStep :
        StepBase<AddDeductionConfirmationStep>, IConfirmationAction
    {
        ...
        private void Insert(TenantOnboardingOrchestrator parent,
            [Inject] IAddDeductionConfirmationStepDal dal)
        {
            using (BypassPropertyChecks)
            {
                var dto = new AddDeductionConfirmationStepDto
                {
