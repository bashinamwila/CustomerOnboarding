...
{
    [Serializable]
    public class WageTypeTypeInfo : ReadOnlyBase<WageTypeTypeInfo>
    {
        ...
        private class GetName : Csla.Rules.BusinessRule
        {
            ...
            {
                var target = (WageTypeTypeInfo)context.Target;
        ...
        [Fetch]
        private void Fetch(int id, [Inject] IWageTypeTypeDal dal)
        {
