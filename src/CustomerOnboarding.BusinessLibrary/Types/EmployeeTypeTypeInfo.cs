...
{
    [Serializable]
    public class EmployeeTypeTypeInfo : ReadOnlyBase<EmployeeTypeTypeInfo>
    {
        ...
        private class GetName : Csla.Rules.BusinessRule
        {
            ...
            {
                var target = (EmployeeTypeTypeInfo)context.Target;
        ...
        [Fetch]
        private void Fetch(int id, [Inject] IEmployeeTypeTypeDal dal)
        {
