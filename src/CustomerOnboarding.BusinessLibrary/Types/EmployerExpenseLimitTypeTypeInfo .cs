...
{
    [Serializable]
    public class EmployerExpenseLimitTypeTypeInfo : ReadOnlyBase<EmployerExpenseLimitTypeTypeInfo>
    {
        ...
        private class GetName : Csla.Rules.BusinessRule
        {
            ...
            {
                var target = (EmployerExpenseLimitTypeTypeInfo)context.Target;
        ...
        private class GetFullName : Csla.Rules.BusinessRule
        {
            protected override void Execute(IRuleContext context)
            {
                ...
                var indexOfComma = fullTypeName.IndexOf(",");
                var fullName = fullTypeName.Substring(0, indexOfComma);
        ...
        [Fetch]
        private void Fetch(int id, [Inject] IEmployerExpenseLimitTypeDal dal)
        {
