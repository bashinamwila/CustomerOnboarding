...
{
    [Serializable]
    public class DeductionTypeTypeInfo : ReadOnlyBase<DeductionTypeTypeInfo>
    {
        ...
        private class GetName : Csla.Rules.BusinessRule
        {
            ...
            {
                var target = (DeductionTypeTypeInfo)context.Target;
        ...
        [Fetch]
        private void Fetch(int id, [Inject] IDeductionTypeDal dal)
        {
