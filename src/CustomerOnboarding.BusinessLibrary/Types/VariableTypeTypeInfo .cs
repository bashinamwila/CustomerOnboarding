...
{
    [Serializable]
    public class VariableTypeTypeInfo : ReadOnlyBase<VariableTypeTypeInfo>
    {
        ...
        public static readonly PropertyInfo<string> PatternProperty =
          RegisterProperty<string>(nameof(Pattern));
        public string Pattern
        {
            get { return GetProperty(PatternProperty); }
            private set { LoadProperty(PatternProperty, value); }
        }
        ...
        private class GetName : Csla.Rules.BusinessRule
        {
            ...
            {
                var target = (VariableTypeTypeInfo)context.Target;
        ...
        [Fetch]
        private void Fetch(int id, [Inject] IVariableTypeDal dal)
        {
        ...
        [FetchChild]
        private void Fetch(VariableTypeDto data)
        {
            Id = data.Id;
            FullTypeName = data.TypeName;
            Pattern = data.Pattern;
