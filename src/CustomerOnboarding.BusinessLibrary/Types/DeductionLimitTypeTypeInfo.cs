...
{
    [Serializable]
    public class DeductionLimitTypeTypeInfo : ReadOnlyBase<DeductionLimitTypeTypeInfo>
    {
        ...
        private class GetName : Csla.Rules.BusinessRule
        {
            ...
            {
                var target = (DeductionLimitTypeTypeInfo)context.Target;
        ...
        [Fetch]
        private void Fetch(int id, [Inject] IDeductionLimitTypeDal dal)
        {
