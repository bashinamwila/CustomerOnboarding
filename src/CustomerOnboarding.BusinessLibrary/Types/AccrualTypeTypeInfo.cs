...
{
    [Serializable]
    public class AccrualTypeTypeInfo : ReadOnlyBase<AccrualTypeTypeInfo>
    {
        ...
        private class GetName : Csla.Rules.BusinessRule
        {
            ...
            {
                var target = (AccrualTypeTypeInfo)context.Target;
        ...
        [Fetch]
        private void Fetch(int id, [Inject] IAccrualTypeTypeDal dal)
        {
