...
{
    [Serializable]
    public class CompensationComponentsStepStepsFactory :
        OnboardingStepsFactoryBase<CompensationComponentsStepStepsFactory>
    {

        [Fetch]
        private async Task FetchAsync(
            string tenantId, int currentStepIndex,
            [Inject] ICompensationComponentsStepStepsDal dal,
