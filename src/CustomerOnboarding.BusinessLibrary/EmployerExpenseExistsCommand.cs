...
{
    [Serializable]
    public class EmployerExpenseExistsCommand : CommandBase<EmployerExpenseExistsCommand>
    {
        ...
        [Execute]
        private void Execute(string tenantId, string id, [Inject] IEmployerExpenseDal dal)
        {
