...
{
    public class GeneralDeductionsInformationDal :
        IGeneralDeductionsInformationDal
    {
        public GeneralDeductionsInformationDto Fetch(string tenantId, int id)
        {
            var result = (from r in MockDb.GeneralDeductionsInformationSteps
                          join s in MockDb.Steps on r.Id equals s.Id
                          where r.TenantId == tenantId
                          && r.Id == id
                          select new GeneralDeductionsInformationDto
                          {
                              TenantId = r.TenantId,
                              StepId = r.Id,
            ...
            if (result is null)
                throw new DataNotFoundException("GeneralDeductionsInformationStep");
            return result;
        }
        ...
        public void Insert(GeneralDeductionsInformationDto dto)
        {
            ...
            var newItem = new GeneralDeductionsInformationEntity
            {
            ...
            MockDb.GeneralDeductionsInformationSteps.Add(newItem);
        }
        ...
        public void Update(GeneralDeductionsInformationDto dto)
        {
            ...
            if (!result.LastChanged.Matches(dto.LastChanged))
                throw new ConcurrencyException("GeneralDeductionsInformationStep");
            dto.LastChanged = MockDb.GetTimeStamp();
