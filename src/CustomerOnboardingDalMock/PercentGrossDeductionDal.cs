...
{
    public class PercentGrossDeductionDal :
        IPercentGrossDeductionDal
    {
        ...
        public TypeOfDeductionDto Fetch(string tenantId, string id)
        {
            ...
            var result = MockDb.PercentGrossDeductions.Where(r => r.TenantId == tenantId && r.DeductionId == id).
            ...
            if (result == null)
                throw new DataNotFoundException("PercentGrossDeduction");
            return result;
        }
        ...
        public void Insert(TypeOfDeductionDto data)
        {
            ...
            var newItem = new PercentGrossDeductionEntity
            {
                Id = data.Id,
